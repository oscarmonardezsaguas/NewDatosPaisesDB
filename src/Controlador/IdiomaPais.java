...
public class IdiomaPais extends Pais
{
    ...
    public IdiomaPais(String idiomaPais, String isOfficial, float porcetajeIdioma, String nombre, String continente, String Ciudades, String region, float superficie, int añoIndp, int poblacion, float expVida, float proNaciBruto, String tipoGob, String jefeEstado, String cityCapital, String codePais, String idioma) 
    {
