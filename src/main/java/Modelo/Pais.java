...
public class Pais 
{
    ...
    public Pais(String nombre, String continente, String Ciudades, String region, float superficie, int añoIndp, int poblacion, float expVida, float proNaciBruto, String tipoGob, String jefeEstado, String cityCapital, int codePais, String idioma) 
    {
        this.nombre = nombre;
    ...
    public Pais(String nombre, String continente, int poblacion, int codePais) 
    {
        this.nombre = nombre;
        this.continente = continente;
        this.poblacion = poblacion;
